...
--
-- Хост: mysql-5.7
-- Время создания: Окт 29 2025 г., 17:55
...
--
ALTER TABLE `plots`
  MODIFY `plot_id` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `users`
  MODIFY `user_id` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
COMMIT;
